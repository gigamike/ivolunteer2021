...
use Application\Service\ServiceCurl;
    ...
    public function getServiceConfig()
    {
        return [
            'factories' => [
                ...
                'ServiceCurl' => function ($sm) {
                    $service = new ServiceCurl();
    ...
    public function getViewHelperConfig()
    {
        return [
            'factories' => [
                ...
                'getAge' => function ($sm) {
                    return new \Application\View\Helper\GetAge($sm->getServiceLocator());
                },
                'getEventVolunteerProgress' => function ($sm) {
                    return new \Application\View\Helper\GetEventVolunteerProgress($sm->getServiceLocator());
                },
                'getEventTeamProgress' => function ($sm) {
                    return new \Application\View\Helper\GetEventTeamProgress($sm->getServiceLocator());
                },
                'getEventTeamMembers' => function ($sm) {
                    return new \Application\View\Helper\GetEventTeamMembers($sm->getServiceLocator());
                },
            ]
        ];
    }
