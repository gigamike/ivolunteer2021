...
use Event\Form\AdminEventEditFilter;

class AdminEventEditForm extends Form
{
    public function __construct(Adapter $dbAdapter, $categoryMapper)
    {
        parent::__construct('admin-event-edit');
        $this->setInputFilter(new AdminEventEditFilter($dbAdapter));
        ...
        $this->add([
            ...
            'attributes' => [
                ...
                'id' => 'name',
                'required' => 'required',
                'data-validation-required-message' => 'Please enter your venue.',
                'autofocus' => 'autofocus',
                'placeholder' => 'Venue',
            ],
        ]);
